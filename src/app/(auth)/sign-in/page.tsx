      ...
      <Card className={`border ${borderColor} ${panelBg} shadow-2xl rounded-[2rem] overflow-hidden backdrop-blur-3xl`}>
        ...
        <CardContent className="px-8 py-6 space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <Button variant="outline" className={`w-full ${hoverBg} ${textColor} border-${borderColor} rounded-xl h-11 bg-transparent hover:border-emerald-500/50 transition-all shadow-sm`} onClick={() => console.log('Google login')}>
              <FcGoogle className="mr-2 h-5 w-5" />
              Google
            </Button>
            <Button variant="outline" className={`w-full ${hoverBg} ${textColor} border-${borderColor} rounded-xl h-11 bg-transparent hover:border-emerald-500/50 transition-all shadow-sm`} onClick={() => console.log('Github login')}>
